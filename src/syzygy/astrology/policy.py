...
default. docs/old/DESIGN.md section 9.4 states the point plainly: "the point is not
...
#: policy evolves (docs/old/DESIGN.md section 24, section 9.4).
POLICY_VERSION = "transit-policy-v1"

#: Maximum orb, in degrees, for each major aspect (docs/old/DESIGN.md section 9.4).
...
#: Midheaven, regardless of aspect type (docs/old/DESIGN.md section 9.4).
...
#: of aspect type or target (docs/old/DESIGN.md section 9.4). The Moon moves fast
